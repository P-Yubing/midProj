...
<body>
  <h3>최신순 조회</h3>
  <% 
    List<ClassInfoVO> filteredRecentClass = (List<ClassInfoVO>) request.getAttribute("filteredRecentClass");
  
  	ClassPicVO cpv = (ClassPicVO) request.getAttribute("getClassPic");
  
    if (filteredRecentClass != null && !filteredRecentClass.isEmpty()) {
      // classWishCount 기준으로 내림차순 정렬

      for (ClassInfoVO classInfo : filteredRecentClass) {
  %>
        <div class="card">
